...
CNN.save('ConvLSTM_improved.h5')

callback_list = [ModelCheckpoint(filepath='ConvLSTM_improved_checkpoint.h5', monitor='val_loss', save_best_only=True), TensorBoard(log_dir="logs".format(time.asctime()))]
