...
X_train = np.asarray(X_train).reshape(-1, 10, sample_width, sample_height, 4)
...
CNN.save('ConvLSTM_pen.h5')

callback_list = [ModelCheckpoint(filepath='ConvLSTM_pen_checkpoint.h5', monitor='val_loss', save_best_only=True), TensorBoard(log_dir="logs".format(time.asctime()))]
