...
CNN.add(Conv2D(96, (11, 11), activation='relu', input_shape=(sample_width, sample_height), strides=(4,4), padding='same'))
CNN.add(Dropout(0.0))
...
CNN.save('ConvCNN_improved.h5')

callback_list = [ModelCheckpoint(filepath='ConvCNN_improved_checkpoint.h5', monitor='val_loss', save_best_only=True), TensorBoard(log_dir="logs".format(time.asctime()))]
